/*  1. si un proceso genera un evento A la rutinas que gestionaran esa ocurrencia de a se ejecutan  Sincrónicamente. Las rutinas gestoras son ejecutadas secuencialmente en el turno actual. La cola de turnos no se utiliza para nada en estas gestiones.
    ...
    4. El identificador "resume" es el nombre de este elemento en el módulo 'stream' de Node.js: Una operación en streams de tipo Readable que reanuda la actividad en un stream previamente pausado.
